        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Add New Products</h3>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="card card-outline-primary">
                        <div class="card-header">
                            <h4 class="m-b-0 text-white">Add Product to Service</h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group has-danger">
                                                ...
                                                <textarea name="about" class="form-control form-control-danger" style="height: 120px;" placeholder="Product Description"></textarea>
                                            </div>
                                        </div>
                                    </div>
