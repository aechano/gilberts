                                        ...
                                        <tbody>
                                            ...
                                            if (!mysqli_num_rows($query_res) > 0) {
                                                ...
                                                while ($row = mysqli_fetch_array($query_res)) {
                                                    ...
                                                    $query_res_paint = mysqli_query($db, "select * from paint where o_id='" . $row['o_id'] . "'");
                                                    $paint = mysqli_fetch_assoc($query_res_paint);
                                                    $brand = $paint['paint_brand'];
                                                    $color = $paint['paint_color'];
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td data-column="Paint Brand"><?php echo $brand; ?></td>
                                                        <td data-column="Color"><?php echo $color; ?></td>                                          
