...
<body class="home">
    ...
    <!-- banner part starts -->
    <section class="hero bg-image" data-image-src="images/img/header.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Gilbert's Aluminum and Glassworks</h1>
                <h5 class="font-white space-xs">Let your furniture be useful until the future.</h5>
                <div class="banner-form">
                    <form class="form-inline">
                        <div class="form-group">
                            <label class="sr-only" for="exampleInputAmount">I would like to order....</label>
                            <div class="form-group">
                                <input type="text" class="form-control form-control-lg" id="exampleInputAmount" placeholder="I would like to order....">
                            </div>
                        </div>
                        <button onclick="location.href='services.php'" type="button" class="btn theme-btn btn-lg">Search</button>
                    </form>
                </div>
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span>1. </span>Choose Services</h4>
                    </div>
                    <!-- end:Step -->
                    <div class="step-item step2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 380.721 380.721">
                            <g fill="#FFF">
                                <path d="M 55.344 60.908 c 0 0 1.289 -5.124 6.892 -4.013 l 101.674 13.442 c 5.602 1.111 5.985 6.884 5.985 6.884 l -7.484 233.031 c 0 0 -0.483 5.725 -6.085 4.614 L 49.594 295.452 c -5.602 -1.111 -4.25 -6.648 -4.25 -6.648 z M 203.111 60.036 c 0 0 0.564 -4.836 6.298 -4.069 l 102.989 13.175 c 5.734 0.767 6.431 5.676 6.431 5.676 l -0.169 233.831 c 0 0 -0.224 5.597 -6.239 5.322 l -104.072 -13.297 c -6.015 -0.275 -5.012 -5.81 -5.012 -5.81 z M 351.218 53.885 c 0 0 3.142 -4.38 8.729 -2.156 l 7.953 2.915 c 5.587 2.225 4.91 7.346 4.91 7.346 l -18.229 198.828 c 0 0 -0.689 4.53 -6.277 2.305 l -7.953 -2.915 c -5.587 -2.225 -3.384 -8.323 -3.384 -8.323 z M 268.92 12.695 c 0 0 -2.121 -1.912 0.311 -5.124 l 7.577 -8.323 c 2.432 -3.212 7.577 -3.758 7.577 -3.758 l 78.646 -0.337 c 0 0 5.145 0.545 7.577 3.758 l 7.577 8.323 c 2.432 3.212 0.311 5.124 0.311 5.124 l -43.229 47.521 c 0 0 -2.74 3.089 -4.52 3.089 L 273.44 60.036 c -1.78 0 -4.52 -3.089 -4.52 -3.089 L 230.7 12.695 z" />
                            </g>
                        </svg>
                        <h4><span>2. </span>Select Product</h4>
                    </div>
                    <!-- end:Step -->
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <p>We got you covered from aluminum to glasswork services</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3>Choose your selected item</h3>
                            <p>We are serving you ready-made and custom-made products</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <p>Get your item delivered within your doorstep..!</p>
                        </div>
                    </div>
                </div>
            </div>
